...
namespace CarsRepositoryLibrary.Services
{
    public class RepositoryService
    {
        ...
        private static Task<bool> EnsureCreated<T>()
        {
            ...
            _dataStoreDictionary
                ...
                ?.FirstOrDefault(e => success = success && (e.Value as ICreatable).EnsureCreated().Result);
        ...
        public static void Register<T>(string connectionString) where T : class, ICreatable,  new()
        {
